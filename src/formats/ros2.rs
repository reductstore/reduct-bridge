...
mod tests {
    ...
    fn payload() -> Bytes {
        Bytes::from_static(&[
            0, 1, 0, 0, 207, 16, 73, 89, 110, 118, 183, 24, 7, 0, 0, 0, 47, 119, 111, 114, 108,
            100, 0, 0, 0, 0, 0, 0, 163, 9, 34, 28, 203, 51, 56, 192, 93, 59, 148, 253, 108, 246,
            29, 192, 51, 217, 2, 127, 219, 56, 1, 64,
        ])
    }
